    ...
    <div> 
    {
     ...
     :
      <div className='bg-[#364b3a] h-full'>
        <Navbar/>
        <div className='flex flex-row items-center justify-center text-white h-[85vh] lg:h-[80vh] pb-56   '>
          <div className='flex flex-col items-center z-[20] space-y-3 cursor-pointer'>
            <span className=' text-[60px] md:text-[100px] lg:text-[160px] font-ahsing'>
              CalyxDAO
            </span>
            <span className='text-lg md:text-2xl text-center font-codec'>
        ...
        <div className='w-full flex flex-row items-end justify-end  '>
          <div className=' font-codec absolute text-[10px] md:text-xl lg:text-2xl  w-14 md:w-32 text-center px-1 -ml-[92px] md:-ml-[157px] lg:mr-[330px] translate-y-[110px] md:translate-y-[220px] lg:translate-y-[340px]'>
        ...
        <div id='About' className='flex flex-row items-end justify-center '>
          ...
          <div className='basis-3/4 '>
            <img src='/images/honeycomb.png' alt='about Photo' className='w-[690px] lg:mx-16 -translate-y-[50px] md:-translate-y-[90px]'  />
          </div>
